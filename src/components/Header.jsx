...
function Header() {
  const { isDark, toggleTheme, generateNewColors } = useContext(ThemeContext);

  return (
    <div className='card glass-card mx-auto header-card d-flex flex-row justify-content-between align-items-center w-100 homepage-card' style={{ maxWidth: "900px" }}>
        <h4 className='d-inline-block'>Current: Student</h4>
        <div className="btn-group p-0">
            <button className='btn p-0'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="white" stroke="white" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-sun"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M8 12a4 4 0 1 0 8 0a4 4 0 1 0 -8 0" /><path d="M3 12h1m8 -9v1m8 8h1m-9 8v1m-6.4 -15.4l.7 .7m12.1 -.7l-.7 .7m0 11.4l.7 .7m-12.1 -.7l-.7 .7" /></svg></button>
